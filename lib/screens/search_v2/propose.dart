...
class Propose extends StatefulWidget {
  ...
  const Propose({super.key, required this.currentPosition});
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Row(
            ...
            children: [
              Text('Đề xuất', style: TextStyle(color: vietnamRed)),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Placeholder content for Propose screen
              Card(
                elevation: 4,
                color: Colors.white,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Nội dung đề xuất sẽ được thêm sau...',
