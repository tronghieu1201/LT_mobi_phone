// lib/view/view_drink.dart (updated)
import 'dart:ui_web' as ui;
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'dart:html' as html;
import 'view_v2/propose_v2.dart'; // Import ProposeV2 để sử dụng trực tiếp
...
class _ViewDrinkState extends State<ViewDrink> {
  ...
  // Categories for drinks related to water/drinks
  final List<String> _drinkCategories = ['Nước mía', 'Cafe', 'Trà sữa', 'Sinh tố', 'Nước ép'];
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Wrap(
                          ...
                          children: _drinkCategories.map((category) => _buildSuggestButton(category)).toList(),
                        ),
                      ),
                    ],
                  ),
