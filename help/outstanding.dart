...
class _OutstandingState extends State<Outstanding> {
  ...
  Future<void> _fetchAndFilterLocations() async {
    _currentPosition = widget.currentPosition ?? _defaultPosition;
    if (_currentPosition == null) {
      await _loadCurrentPositionForOutstanding(); // Load vị trí thật
    ...
    final List<Map<String, dynamic>> allLocs = snapshot.docs
        ...
        .where((loc) => loc['category'] == widget.category) // Filter theo category
        .toList();
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Danh sách ${widget.category ?? ''} trong 5km (${_filteredLocations.length} nơi)',
                          style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: vietnamRed),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                          'Đang quét ${widget.category ?? ''} trong 5km...',
